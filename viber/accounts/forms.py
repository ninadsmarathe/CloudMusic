...
"""login using username/email and password only changes in models.py and views.py"""
...
"""normal login using username and password only changes in models.py and views.py"""
